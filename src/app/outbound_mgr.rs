    ...
    pub fn from_config_full(
        ...
        for cfg in configs {
            ...
            let ob: Arc<dyn Outbound> = match cfg {
                ...
                #[cfg(not(feature = "outbound-net"))]
                OutboundConfig::ShadowQuic(c) => fallback_block(&c.tag, "ShadowQuic"),
                ...
                #[cfg(not(feature = "outbound-net"))]
                OutboundConfig::Naive(c) => fallback_block(&c.tag, "Naive"),
                ...
                #[cfg(not(feature = "outbound-net"))]
                OutboundConfig::Ssh(c) => fallback_block(&c.tag, "SSH"),
                ...
                #[cfg(not(feature = "outbound-net"))]
                OutboundConfig::Tailscale(c) => fallback_block(&c.tag, "Tailscale"),
            };
            map.insert(tag, ob);
        }
