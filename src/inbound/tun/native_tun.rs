//! NativeTun: TUN 设备的高级封装。
//!
//! 在 tun crate 基础上提供：
//! - Linux: GSO/GRO 卸载（virtio_net_hdr），批量 I/O（readv/writev）
//! - macOS: 批量 I/O（MSG_HDR）
//! - Windows: wintun 环缓冲原生读写
//!
//! 参照 sing-tun NativeTun 的设计，为各平台提供统一的高性能 I/O 抽象。
