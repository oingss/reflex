...
use crate::config::dns::{DnsQueryType, DnsRuleConfig};
use crate::dns::upstream::{DnsUpstream, UpstreamKind};
use crate::ruleset::RuleSet;

pub(super) struct CompiledDnsRule {
    pub(super) inbound_tags: Vec<String>,
    pub(super) query_types: Vec<u16>,
...
impl CompiledDnsRule {
    pub(super) fn compile(
        ...
        let compiled_upstreams =
            resolve_server_ref(rule.server.as_slice(), upstreams, "dns.rules[].server")?;
